                    ...
                    <div className="rounded-lg shadow-lg shadow-gray-300 bg-gray-100 w-90 h-auto">
                        <div style={{ width: "380px" }} className="px-8 sm:p-6" noValidate onSubmit={handleSubmitPassword}>
                            ...
                            <div>
                                ...
                                />
                                {validData.password && (
                                    <div style={{ marginLeft: '273px' }} className="absolute -mt-10 text-green-400 text-xl pointer-events-none">
                                        <Check />
                                    </div>
                                )}
                                {!validData.password && data.password && (
                                    <div style={{ marginLeft: '273px' }} className="absolute -mt-10 text-red-400 text-xl pointer-events-none">
                                        <Cross />
                                    </div>
                                )}
                                <p
                                ...
                                <p
                                    className={
                                        focus.confirmPassword && data.confirmPassword && !validData.confirmPassword
                                            ? "block font-roboto text-red-700 bg-[#f0e1e1] mb-2 mt-4 rounded p-2"
                                            : "hidden"
                                    }
                                >
                                    <Info />
